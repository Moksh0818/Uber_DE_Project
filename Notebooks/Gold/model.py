...
def dim_booking_view():
   df = spark.readStream.table("uber.silver.silver_obt")
   df = df.select("ride_id", "confirmation_number", "dropoff_location_id", "ride_status_id", "dropoff_city_id", "cancellation_reason_id", "dropoff_address", "dropoff_Latitude", "dropoff_Longitude", "booking_timestamp", "dropoff_timestamp", "pickup_latitude", "pickup_longitude", "pickup_location_id")
